            ...
            <table className="table table-hover mt-5 table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th scope="col">EngishOral</th>
                  <th scope="col">Nepali</th>
                  <th scope="col">NepaliOral</th>
          ...
          <table className="table table-hover mt-5 table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <th>{Gpa(index.EnglishOral, 50)}</th>
              </tr>
              ...
              <tr>
                <th scope="row">7</th>
                <th>Social</th>
                <th>{grade(index.Social, 100)}</th>
                <th>{Gpa(index.Social, 100)}</th>
              </tr>
              ...
              <tr>
                ...
                <th>{Gpa(index.HandWriting, 20)}</th>
              </tr>
